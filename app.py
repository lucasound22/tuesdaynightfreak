...
# ---------------------------
# SVG LOGOS (kept as Python strings)
# ---------------------------
HKR_LOGO_SVG = """
...
if 'loader_done' not in st.session_state:       st.session_state.loader_done = False
...
# ---------------------------
# LOADER (render only once using session_state.loader_done)
# ---------------------------
if not st.session_state.loader_done:
    st.markdown(f"""
    <div class="loading-overlay" id="loader">
        <div class="glitch-text">{TNF_LOGO_SVG}</div>
...
# ---------------------------
# JAVASCRIPT – Visualizer (initialises on user interaction)
# ---------------------------
st.markdown("""
<script>
...
// init visualiser on first click (user gesture required by browsers)
